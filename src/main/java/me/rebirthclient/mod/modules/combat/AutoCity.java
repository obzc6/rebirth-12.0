...
public class AutoCity extends Module {
    ...
    private void doBreak(PlayerEntity player) {
                ...
                for(int var9 = 0; var9 < var8; ++var9) {
                    ...
                    for(int var14 = 0; var14 < var13; ++var14) {
                        ...
                        for(int var19 = 0; var19 < var18; ++var19) {
                            ...
                            if (this.isObsidian(offsetPos) && offsetPos.equals(PacketMine.breakPos)) {
                                return;
                            }
                        }
                    }
        ...
        if (this.surround.getValue()) {
            ...
            for(var26 = 0; var26 < var24; ++var26) {
                i = var23[var26];
                if (i != Direction.UP && i != Direction.DOWN && !PacketMine.godBlocks.contains(BlockUtil.getBlock(pos.offset(i))) && !(BlockUtil.getBlock(pos.offset(i)) instanceof BedBlock)) {
    ...
    private boolean isObsidian(BlockPos pos) {
        return (BlockUtil.getBlock(pos) == Blocks.OBSIDIAN || BlockUtil.getBlock(pos) == Blocks.ENDER_CHEST) && BlockUtil.getClickSideStrict(pos) != null && (!pos.equals(PacketMine.secondPos) || !(mc.player.getMainHandStack().getItem() instanceof PickaxeItem) && !SilentDouble.INSTANCE.isOn());
    }
}

...
public class Velocity extends Module {
    ...
    public final BooleanSetting waterPush = new BooleanSetting("WaterPush",true);
    public final BooleanSetting entityPush = new BooleanSetting("EntityPush",true);
    public final BooleanSetting blockPush = new BooleanSetting("BlockPush",true);
    public BooleanSetting noExplosions = new BooleanSetting("NoExplosions",true);
    public Velocity() {
